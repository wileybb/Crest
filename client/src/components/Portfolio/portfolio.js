                                                 ...
                                                 return (
                                                     <tr>
                                                         ...
                                                         <td>{data.latestPriceIEX}</td> 
                                                          ...
                                                          <td>{(((parseFloat(data.Stockquantity))*(data.latestPriceIEX)) > parseFloat(data.TotalPurchase)) ? (((parseFloat(data.Stockquantity))*(data.latestPriceIEX))-parseFloat(data.TotalPurchase)) : (parseFloat(data.TotalPurchase)-(parseFloat(data.Stockquantity)*(data.latestPriceIEX)))}</td> 
                                                     </tr>)
                                             })}
                                         </tbody>
                                     </table>
